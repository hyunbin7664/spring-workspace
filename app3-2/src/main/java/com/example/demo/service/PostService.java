...
//	}
	...
	public Page<Post> getPosts(int currentPage, Map<String, Object> condition) {
		...
		// condition -> opt='title', keyword='연습', offset=0, rows=10
		List<Post> posts = postMapper.getPosts(condition);
