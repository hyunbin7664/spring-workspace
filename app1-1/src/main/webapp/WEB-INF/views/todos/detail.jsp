        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4"><fmt:formatDate value="${todo.dueDate }" pattern="yyyy-MM-dd"/></div>
                    <div class="col-md-2 fw-bold">완료일자</div>
                    <div class="col-md-4">-</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2 fw-bold">상태</div>
                    <div class="col-md-4"><span class="badge bg-warning">${todo.status }</span></div>
                    <div class="col-md-2 fw-bold">작성자</div>
                    <div class="col-md-4">${todo.user.name }</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2 fw-bold">등록일</div>
                    <div class="col-md-4"><fmt:formatDate value="${todo.createdDate }" pattern="yyyy-MM-dd hh:mm"/></div>
                    <div class="col-md-2 fw-bold">최종수정일</div>
                    <div class="col-md-4"><fmt:formatDate value="${todo.updatedDate }" pattern="yyyy-MM-dd hh:mm"/></div>
                </div>
            </div>
        </div>
    </div>
